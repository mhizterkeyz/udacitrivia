...
from settings import TEST_DB_NAME, DB_USER, DB_HOST, DB_PASSWORD
...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = f"postgresql://{DB_USER}:{DB_PASSWORD}@{DB_HOST}/{TEST_DB_NAME}"
    ...
    def test_get_quiz_question(self):
        ...
        res = self.client().post('/quizzes', json={ 'previous_questions': previous_questions, 'quiz_category': { 'id': 0 } })
        data = json.loads(res.data)
